...
**SAFF REYNOLDS** — 22. Captain. Mal and Inara's daughter. Stops running from the inheritance and starts owning it.

**CAS WASHBURNE** — 23. Pilot. Zoe and Wash's daughter. Her father teaches her from a recording. From beyond the grave.
...
| # | Title | Status |
|---|-------|--------|
| 01 | [SHINY](episodes/episode_01.md) | Complete |
| 02 | [Same Sky, Different Dust](episodes/episode_02.md) | Complete |
| 03 | [Dave](episodes/episode_03.md) | Complete |
| 04 | [Leaf on the Wind](episodes/episode_04.md) | Complete |
| 05 | [A Mother and Companion](episodes/episode_05.md) | Complete |
| 06 | [Baby](episodes/episode_06.md) | Complete |
| 07 | [Signal](episodes/episode_07.md) | Complete |
...
- [Series Bible](docs/series_bible.md) — Characters, arcs, canon rules
...
This project is free to share, adapt, illustrate, score, translate, perform, and build upon for any non-commercial purpose.

**Write the next episode. Draw the characters. Compose the score. Make the thing you wish existed.**

The only rules:

1. **Non-commercial only.** Nobody makes money from this.
2. **Credit the original.** Firefly belongs to Joss Whedon and the people who made it.
